...
export const AdminReports: React.FC = () => {
  ...
  const loadReports = async () => {
    ...
    try {
      ...
      // ?? CORRE??O 1: Filtrar relat車rios que t那m empresa v芍lida
      ...
      console.error('Erro ao carregar relat車rios:', err);
      setError(err.response?.data?.message || 'Erro ao carregar relat車rios');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-500">Carregando relat車rios...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Relat車rios de Recomenda??es</h1>
                <p className="text-sm text-gray-500">
                  Gerencie todos os relat車rios gerados pelas empresas
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Tabela de Relat車rios */}
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Lista de Relat車rios</CardTitle>
              <span className="text-sm text-gray-500">
                {reports.length} {reports.length === 1 ? 'relat車rio' : 'relat車rios'}
              </span>
            </div>
          </CardHeader>
          <CardContent>
            {error ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900">Nenhum relat車rio encontrado</h3>
                <p className="text-gray-500 mt-1">
                  {search || statusFilter !== 'all' 
                    ? 'Tente ajustar os filtros de busca' 
                    : 'Os relat車rios ser?o gerados automaticamente quando as empresas come?arem a responder os controles'}
                </p>
              </div>
            ) : (
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      ...
                      <th className="text-left text-xs font-medium text-gray-500 uppercase tracking-wider py-3 px-4">Per赤odo</th>
                ...
                {totalPages > 1 && (
                  <div className="flex items-center justify-between px-4 py-3 border-t border-gray-200">
                    <div className="text-sm text-gray-500">
                      P芍gina {currentPage} de {totalPages}
                    </div>

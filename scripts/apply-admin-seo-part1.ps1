# scripts/apply-admin-seo-part1.ps1
# Script para aplicar Parte 1/3 - Estrutura Semântica e Headings
...
Write-Host "║     PARTE 1/3 - ESTRUTURA SEMÂNTICA E HEADINGS            ║" -ForegroundColor $Colors.Header
Write-Host "╚═══════════════════════════════════════════════════════════════╝" -ForegroundColor $Colors.Header
Write-Host ""
...
# PARTE 1: ADMIN USERS
# ============================================
Write-Step "PARTE 1/3: ADMIN USERS"
...
export const AdminUsers: React.FC = () => {
  ...
  return (
    <>
      <MetaTags
        title="Gerenciar Usuários - Code_Assessment (Admin)"
        description="Painel administrativo para gerenciar usuários do sistema Code_Assessment."
        noIndex={true}
        canonical="https://code-assessment.com/admin/users"
      />
...
# ============================================
Write-Step "PARTE 2/3: ADMIN DASHBOARD"
  ...
  return (
    <>
      <MetaTags
        ...
        description="Painel administrativo do Code_Assessment com métricas e indicadores do sistema."
        noIndex={true}
        canonical="https://code-assessment.com/admin"
      />
...
# PARTE 3: USERS TABLE
# ============================================
Write-Step "PARTE 3/3: USERS TABLE"
...
Write-Info "  ✅ Tags HTML5 semânticas (main, header, section, nav)" -ForegroundColor White
Write-Info "  ✅ Hierarquia correta de headings (H1 → H2)" -ForegroundColor White
Write-Info "  ✅ ARIA roles e labels" -ForegroundColor White
Write-Info "  ✅ Meta Tags com noIndex para admin" -ForegroundColor White
...
Write-Info "  3. Verifique a estrutura HTML com ferramentas de desenvolvedor" -ForegroundColor White
Write-Info "  4. Verifique as tags meta (noindex)" -ForegroundColor White

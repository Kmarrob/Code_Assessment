 ...
 */
var paymentStatusHistorySchema = new mongoose_1.Schema({
    status: {
        type: String,
 ...
 * Schema de item
 */
var paymentItemSchema = new mongoose_1.Schema({
 ...
 * Schema de desconto
 */
var paymentDiscountSchema = new mongoose_1.Schema({
    type: {
        type: String,
 ...
 * Schema de taxa
 */
var paymentFeeSchema = new mongoose_1.Schema({
    type: {
        type: String,
 ...
 */
var billingPeriodSchema = new mongoose_1.Schema({
...
paymentSchema.methods.getTotalWithFees = function () {
    var totalItems = this.items.reduce(function (sum, item) { return sum + item.totalPrice; }, 0);
    var totalDiscounts = this.discounts.reduce(function (sum, d) { return sum + d.amount; }, 0);
    var totalFees = this.fees.reduce(function (sum, f) { return sum + f.amount; }, 0);
...
paymentSchema.statics.findByProviderPaymentId = function (providerPaymentId) {
    return this.findOne({ providerPaymentId: providerPaymentId });
};

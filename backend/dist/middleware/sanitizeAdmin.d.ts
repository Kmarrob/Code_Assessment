 ...
 */
export declare function sanitizeAdminInputs(req: Request, _res: Response, next: NextFunction): void;
/**
 * Middleware específico para sanitizar apenas campos sensíveis
 */
export declare function sanitizeSensitiveFields(req: Request, _res: Response, next: NextFunction): void;

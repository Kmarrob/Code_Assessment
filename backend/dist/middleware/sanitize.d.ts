 ...
 */
export declare function sanitizeRequestBody(req: Request, res: Response, next: NextFunction): void;
export declare function sanitizeQueryParams(req: Request, res: Response, next: NextFunction): void;

...
export declare class AuditReportController {
    ...
    submitForReview(req: AuthenticatedRequest, res: Response): Promise<Response>;
    ...
    generateAutoReport(req: AuthenticatedRequest, res: Response): Promise<Response>;
}
//# sourceMappingURL=AuditReportController.d.ts.map
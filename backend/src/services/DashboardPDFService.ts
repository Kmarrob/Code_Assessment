...
export class DashboardPDFService {
  ...
  static async generateDashboardPDF(data: DashboardPDFData): Promise<Buffer> {
    ...
    try {
      ...
      try {
        ...
        logger.info(`📊 DashboardPDF: ${chartCount} gráficos encontrados`);
      } catch (error) {
        logger.warn('⚠️ DashboardPDF: Nenhum gráfico Recharts encontrado');
      }
   ...
   */
  private static generateDashboardHTML(data: DashboardPDFData): string {
